...
const HibaNamaGhenar = ({ setActiveStep }) => {
    ...
    <>
      <Paper elevation={5} sx={{ p: 2 }}>
        <Grid container spacing={2}>
                ...
                <Grid container spacing={2}>
                  ...
                  {userType == "self" ? (
                    <Grid item md={12}>
                      {isMHProperty == "no" ? (
                        <UserNoMHProperty
                          heading="हिबानामा घेणाऱ्याची माहिती"
                          inputlabel="हिबानामा घेणाऱ्याचे नाव"
                        />
                      ) : (
                        <>
                          {property == "712" && (
          ...
          <Grid item md={12}>
            <UserAddress type="hibanamaGhenar" />
          </Grid>
      ...
      <Grid item md={12} mt={3}>
        <TableContainer component={Paper} elevation={5}>
          <h3 style={{ marginLeft: 20 }}>
            हिबानामा घेणार( नवीन धारक) माहिती तक्ता
          </h3>
          <Table>
            <TableHead style={{ backgroundColor: "#F4F4F4" }}>
              <TableRow>
                ...
                <TableCell rowSpan={2}>हिबानामा घेणाराचा प्रकार</TableCell>
                <TableCell colSpan={3}>हिबानामा घेणाराचे नाव</TableCell>
                ...
                <TableCell rowSpan={2}>
                  हिबानामा नुसार क्षेत्र (चौ.मी.)
                </TableCell>
                <TableCell rowSpan={2}>हिबानामा घेणाऱ्याचा पत्ता</TableCell>
