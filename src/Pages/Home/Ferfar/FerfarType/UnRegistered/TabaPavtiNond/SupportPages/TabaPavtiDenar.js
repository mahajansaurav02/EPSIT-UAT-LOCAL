...
const TabaPavtiDenar = ({ setActiveStep }) => {
    ...
    <>
      <Paper elevation={5} sx={{ p: 2 }}>
        <Grid container spacing={2}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item md={4}>
                {radio == "yes" ? (
                  <>
                    <InputLabel className={styles.inputlabel}>
                      <b> ताबा पावती मध्ये नमूद क्षेत्र (चौ.मी.)</b>
                    </InputLabel>
                    <TextField fullWidth size="small" value={40} disabled />
                  </>
                ) : (
          ...
          <Grid item md={12}>
            <UserAddress type="tabaPavtiDenar" />
          </Grid>
      ...
      <Grid item md={12} mt={3}>
        <TableContainer component={Paper} elevation={5}>
          <h3 style={{ marginLeft: 20 }}>ताबा पावती देणार माहिती तक्ता</h3>
          <Table>
            <TableHead style={{ backgroundColor: "#F4F4F4" }}>
              <TableRow>
                ...
                <TableCell rowSpan={2}>अर्जामधील न.भू.क्र.</TableCell>
                <TableCell rowSpan={2}>LR-Property UID</TableCell>
                <TableCell rowSpan={2}>फेरफरसाठी मिळकत</TableCell>
                <TableCell rowSpan={2}>अर्जामध्ये नमूद मिळकत</TableCell>
                <TableCell colSpan={3}>ताबा पावती देणाराचे नाव</TableCell>
                <TableCell rowSpan={2}>उर्फ नाव</TableCell>
                <TableCell rowSpan={2}>नावे क्षेत्र (चौ.मी.)</TableCell>
                <TableCell rowSpan={2}>
                  ताबा पावती मध्ये नमूद क्षेत्र (चौ.मी.)
                </TableCell>
                <TableCell rowSpan={2}>ताबा पावती देणाराचा पत्ता</TableCell>
