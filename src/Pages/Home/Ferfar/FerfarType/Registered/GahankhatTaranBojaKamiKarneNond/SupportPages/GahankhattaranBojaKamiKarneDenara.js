...
import { gahankhatTaranBojaKamiKarneDenaraNotesArr } from "../../../../../../../NotesArray/NotesArray";
...
const GahankhatTaranBojaKamiKarneDenara = ({ setActiveStep }) => {
    ...
    if (isIndian == "india") {
      ...
      if (result && isUserIndAdd) {
        if (isMobileNoVerified) {
          ...
          //         handleReset();
          //         getGahanKhatKamiKarnarDenarTableData();
          //       } else {
          ...
          console.info("payload-save-gahankhat-kamikarne-denar(bank)->>", {
            applicationid: applicationId,
            userDetails: {
              ...userDetails,
            },
  ...
  const getGahanKhatKamiKarnarDenarTableData = () => {
    sendRequest(
    ...
    <>
      ...
      <Grid item md={12}>
        <NotesPaper
          ...
          arr={gahankhatTaranBojaKamiKarneDenaraNotesArr}
        />
      </Grid>
      ...
      <Paper elevation={5} sx={{ p: 2, mt: 2 }} className="papermain">
        <Grid container spacing={1}>
          ...
          {/* <Grid item md={12} sx={{ margin: 0, mt: -3 }}>
          ...
          <Grid container justifyContent="end" px={2} mt={2}>
            <Grid item>
              ...
              >
                गहाणखत / तारण / बोजा घेणाऱ्याची माहिती भरा
              </Button>
            </Grid>
          </Grid>
        </Grid>
...
export default GahankhatTaranBojaKamiKarneDenara;
