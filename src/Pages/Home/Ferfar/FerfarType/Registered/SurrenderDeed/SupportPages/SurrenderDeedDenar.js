...
const SurrenderDeedDenar = ({ setActiveStep, nabhuDataArr, applicationData }) => {
  ...
  const {
    ...
    resolver: yupResolver(
      yup.object().shape({
        ...
        userName: yup.string().required("सरेंडर डीड देणारा निवडा"),
        ...
        sendRequest(
          ...
          (res) => {
            if (res?.Code == "1") {
              ...
              handleReset();
              getSurrenderDeedDenarTableData();
            } else {
  ...
  const handleDelete = (id) => {
    if (responseData.length == 1) {
      Swal.fire({
        title: `<p style="font-size: 0.8em;">सरेंडर डीड घेणारे सुद्धा डिलीट होतील !</p>`,
        html: '<span style="color: red;">डिलीट झाल्यानंतर पुन्हा नवीन सरेंडर डीड देणारे-घेणारे भरावे लागतील</span>',
        position: "center",
        icon: "warning",
          ...
          sendRequest(
            ...
            (res) => {
              if (res?.Code == "1") {
                ...
                Swal.fire(
                  "Deleted!",
                  "सरेंडर डीड देणारा घेणारा डिलीट झालेला आहे",
                  "success",
                );
                getSurrenderDeedDenarTableData();
                getSurrenderDeedGhenarTableData();
              } else {
                errorToast(res?.Message);
              }
            },
  ...
  const getSurrenderDeedGhenarTableData = () => {
    sendRequest(
  ...
  const getSurrenderDeedDenarTableData = () => {
    sendRequest(
  ...
  return (
    <>
      ...
      <Grid item md={12}>
        <NotesPaper
          heading="सरेंडर डीड देणाराची माहिती भरण्यासाठी आवश्यक सूचना"
      ...
      <Paper elevation={5} sx={{ p: 2, mt: 2 }} className="papermain">
        <Grid container spacing={1}>
          <Grid item md={12}>
            <h4 className="heading">सरेंडर डीड देणार</h4>
          </Grid>
          {isEdit && (
            <Grid item md={12}>
              <Button
              ...
              >
                सरेंडर डीड देणाराच्या माहितीत बदल करा
              </Button>
            </Grid>
          )}
          <Grid item md={12}>
          ...
          <Grid item md={12}>
            {!isEdit && (
              <InputLabel className="inputlabel">
                <b>
                  सरेंडर डीड देणाराचे नाव <span> *</span> (इंग्रजी मध्ये)
                </b>
              </InputLabel>
            )}
            <Grid container justifyContent="space-between">
          ...
          <Grid item md={12}>
            <Grid container spacing={2}>
              ...
              <Grid item md={3}>
                <InputLabel className="inputlabel">
                  <b>सरेंडर डीड देणाऱ्याच्या नावे क्षेत्र (चौ.मी.)</b>
                </InputLabel>
                {isEdit ? (
                  <TextField
                    fullWidth
              ...
              {isEdit ? (
                <Grid item md={3}>
                  <InputLabel className="inputlabel">
                    <b>सरेंडर डीड दिलेले क्षेत्र (चौ.मी.)</b>
                  </InputLabel>
                  <TextField
                    fullWidth
                    className="textfieldDisabled"
          ...
          <Grid container justifyContent="end" px={2}>
            <Grid item>
              ...
              >
                सरेंडर डीड घेणाऱ्याची माहिती भरा
              </Button>
            </Grid>
          </Grid>
        </Grid>
      ...
      <Grid item md={12} mt={2}>
        <TableContainer component={Paper} elevation={5}>
          <h3 style={{ marginLeft: 20 }}>सरेंडर डीड देणारा माहिती तक्ता</h3>
          <Table>
            <TableHead style={{ backgroundColor: "#F4F4F4" }}>
              <TableRow>
                ...
                <TableCell>सरेंडर डीड देणाऱ्याचे नाव</TableCell>
                <TableCell>सरेंडर डीड देणाऱ्याचा पत्ता</TableCell>
                <TableCell>उर्फ नाव</TableCell>
                <TableCell>मिळकत पत्रिके प्रमाणे क्षेत्र (चौ.मी.)</TableCell>
                <TableCell>सरेंडर डीड देणाऱ्याच्या नावे क्षेत्र (चौ.मी.)</TableCell>
                <TableCell>सरेंडर डीड दिलेले क्षेत्र (चौ.मी.)</TableCell>
      ...
      {ghenarData.length > 0 && (
        <Grid item md={12} mt={2}>
          <TableContainer component={Paper} elevation={5}>
            ...
            >
              <h3 style={{ marginLeft: 20 }}>सरेंडर डीड घेणारा माहिती तक्ता</h3>
              <Button
                onClick={() => setActiveStep(1)}
                endIcon={<ArrowForwardRoundedIcon />}
              >
                आणखी सरेंडर डीड घेणाऱ्याची माहिती भरा
              </Button>
            </div>
            <Table>
              <TableHead style={{ backgroundColor: "#F4F4F4" }}>
                <TableRow>
                  ...
                  <TableCell>सरेंडर डीड घेणाराचा प्रकार</TableCell>
                  <TableCell>सरेंडर डीड घेणाऱ्याचे नाव</TableCell>
                  <TableCell>सरेंडर डीड घेणाऱ्याचा पत्ता</TableCell>
                  <TableCell>उर्फ नाव</TableCell>
...
export default SurrenderDeedDenar;
