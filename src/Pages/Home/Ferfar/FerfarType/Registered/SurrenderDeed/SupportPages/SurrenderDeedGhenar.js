...
const SurrenderDeedGhenar = ({ applicationData }) => {
  ...
  return (
    <>
      ...
      <Grid item md={12}>
        <NotesPaper
          heading="सरेंडर डीड घेणारा आवश्यक सूचना"
      ...
      <Paper elevation={5} sx={{ p: 2, mt: 2 }} className="papermain">
        <Grid container spacing={2}>
          {/* ------------------------Newly added--------------------------- */}
          {/* <Grid item md={12}>
            <h4 className="heading">सरेंडर डीड देणारे</h4>
          </Grid>
          ...
          {/* ------------------------Newly added--------------------------- */}
          <Grid item md={12}>
            <h4 className="heading">सरेंडर डीड घेणार</h4>
          </Grid>
                ...
                <Grid container spacing={2}>
                  <Grid item md={12}>
                    <Grid container spacing={2}>
                      <Grid item md={2}>
                        <InputLabel className="inputlabel">
                          <b>सरेंडर डीड घेणाराचा प्रकार </b>
                          <span>*</span>
                        </InputLabel>
                        <Select
                          value={userType}
                  ...
                  {userType == 1 ? (
                    <Grid item md={12}>
                      {isMHProperty == "no" ? (
                        <UserNoMHProperty
                          heading="सरेंडर डीड घेणाऱ्याची माहिती"
                          inputlabel="सरेंडर डीड घेणाऱ्याचे नाव"
                          isEdit={isEdit}
...
export default SurrenderDeedGhenar;
