...
import { AssignmentDeedDenarNotesArr } from "../../../../../../../NotesArray/NotesArray";
...
const AssignmentDeedDenar = ({ setActiveStep, nabhuDataArr, applicationData }) => {
  ...
  const {
    ...
    resolver: yupResolver(
      yup.object().shape({
        ...
        userName: yup.string().required("असाइनमेंट डीड देणारा निवडा"),
        ...
        sendRequest(
          ...
          (res) => {
            if (res?.Code == "1") {
              ...
              handleReset();
              getassignmentDeedDenarTableData();
            } else {
  ...
  const handleDelete = (id) => {
    if (responseData.length == 1) {
      Swal.fire({
        title: `<p style="font-size: 0.8em;">असाइनमेंट डीड घेणारे सुद्धा डिलीट होतील !</p>`,
        html: '<span style="color: red;">डिलीट झाल्यानंतर पुन्हा नवीन असाइनमेंट डीड देणारे-घेणारे भरावे लागतील</span>',
        position: "center",
        icon: "warning",
          ...
          sendRequest(
            ...
            (res) => {
              if (res?.Code == "1") {
                ...
                Swal.fire(
                  "Deleted!",
                  "असाइनमेंट डीड देणारा घेणारा डिलीट झालेला आहे",
                  "success",
                );
                getassignmentDeedDenarTableData();
  ...
  const getassignmentDeedDenarTableData = () => {
    sendRequest(
  ...
  return (
    <>
      ...
      <Grid item md={12}>
        <NotesPaper
          heading="असाइनमेंट डीड देणाराची माहिती भरण्यासाठी आवश्यक सूचना"
          arr={AssignmentDeedDenarNotesArr}
        />
      </Grid>
      ...
      <Paper elevation={5} sx={{ p: 2, mt: 2 }} className="papermain">
        <Grid container spacing={1}>
          <Grid item md={12}>
            <h4 className="heading">असाइनमेंट डीड देणार</h4>
          </Grid>
          {isEdit && (
            <Grid item md={12}>
              <Button
              ...
              >
                असाइनमेंट डीड देणाराच्या माहितीत बदल करा
              </Button>
            </Grid>
          )}
          <Grid item md={12}>
          ...
          <Grid item md={4} mb={2}>
            {isEdit ? (
              <>
                <InputLabel className="inputlabel">
                  <b>असाइनमेंट डीड देणाराचे नाव</b>
                </InputLabel>
                <TextField
                  fullWidth
                  className="textfieldDisabled"
          ...
          <Grid item md={12}>
            {!isEdit && (
              <InputLabel className="inputlabel">
                <b>
                  असाइनमेंट डीड देणाराचे नाव <span> *</span> (इंग्रजी मध्ये)
                </b>
              </InputLabel>
            )}
            <Grid container justifyContent="space-between">
          ...
          <Grid item md={12}>
            <Grid container spacing={2}>
              ...
              <Grid item md={3}>
                <InputLabel className="inputlabel">
                  <b>असाइनमेंट डीड देणाऱ्याच्या नावे क्षेत्र (चौ.मी.)</b>
                </InputLabel>
                {isEdit ? (
                  <TextField
                    fullWidth
              ...
              {isEdit ? (
                <Grid item md={3}>
                  <InputLabel className="inputlabel">
                    <b>असाइनमेंट डीड दिलेले क्षेत्र (चौ.मी.)</b>
                  </InputLabel>
                  <TextField
                    fullWidth
                    className="textfieldDisabled"
              ...
              >
                ...
                >
                  <Typography variant="h5" fontSize="14px" fontWeight={600}>
                    आणखी असाइनमेंट डीड देणार आहे का?
                  </Typography>
                </Grid>
          ...
          <Grid container justifyContent="end" px={2}>
            <Grid item>
              ...
              >
                असाइनमेंट डीड घेणाऱ्याची माहिती भरा
              </Button>
            </Grid>
          </Grid>
        </Grid>
      ...
      <Grid item md={12} mt={2}>
        <TableContainer component={Paper} elevation={5}>
          <h3 style={{ marginLeft: 20 }}>असाइनमेंट डीड देणारा माहिती तक्ता</h3>
          <Table>
            <TableHead style={{ backgroundColor: "#F4F4F4" }}>
              <TableRow>
                ...
                <TableCell>असाइनमेंट डीड देणाऱ्याचे नाव</TableCell>
                <TableCell>असाइनमेंट डीड देणाऱ्याचा पत्ता</TableCell>
                <TableCell>उर्फ नाव</TableCell>
                <TableCell>मिळकत पत्रिके प्रमाणे क्षेत्र (चौ.मी.)</TableCell>
                <TableCell>असाइनमेंट डीड देणाऱ्याच्या नावे क्षेत्र (चौ.मी.)</TableCell>
                <TableCell>असाइनमेंट डीड दिलेले क्षेत्र (चौ.मी.)</TableCell>
      ...
      {ghenarData.length > 0 && (
        <Grid item md={12} mt={2}>
          <TableContainer component={Paper} elevation={5}>
            ...
            >
              <h3 style={{ marginLeft: 20 }}>असाइनमेंट डीड घेणारा माहिती तक्ता</h3>
              <Button
                onClick={() => setActiveStep(1)}
                endIcon={<ArrowForwardRoundedIcon />}
              >
                आणखी असाइनमेंट डीड घेणाऱ्याची माहिती भरा
              </Button>
            </div>
            <Table>
              <TableHead style={{ backgroundColor: "#F4F4F4" }}>
                <TableRow>
                  ...
                  <TableCell>असाइनमेंट डीड घेणाराचा प्रकार</TableCell>
                  <TableCell>असाइनमेंट डीड घेणाऱ्याचे नाव</TableCell>
                  <TableCell>असाइनमेंट डीड घेणाऱ्याचा पत्ता</TableCell>
                  <TableCell>उर्फ नाव</TableCell>
...
export default AssignmentDeedDenar;
