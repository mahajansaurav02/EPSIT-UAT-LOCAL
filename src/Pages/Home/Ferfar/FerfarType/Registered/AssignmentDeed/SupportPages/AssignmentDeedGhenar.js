...
import { AssignmentDeedGhenarNotesArr } from "../../../../../../../NotesArray/NotesArray";
import ShowAddress from "../../SupportPages/ShowAddress";

const AssignmentDeedGhenar = ({ applicationData, setActiveStep }) => {
          ...
          sendRequest(
            ...
            (res) => {
              if (res?.Code == "1") {
                ...
                handleReset();
                getAssignmentDeedGhenarTableData();
              } else {
  ...
  const getAssignmentDeedGhenarTableData = () => {
    sendRequest(
  ...
  return (
    <>
      ...
      <Grid item md={12}>
        <NotesPaper
          heading="असाइनमेंट डीड घेणारा आवश्यक सूचना"
          arr={AssignmentDeedGhenarNotesArr}
        />
      </Grid>
      ...
      <Paper elevation={5} sx={{ p: 2, mt: 2 }} className="papermain">
        <Grid container spacing={2}>
          {/* ------------------------Newly added--------------------------- */}
          {/* <Grid item md={12}>
            <h4 className="heading">असाइनमेंट डीड देणारे</h4>
          </Grid>
          ...
          {/* ------------------------Newly added--------------------------- */}
          <Grid item md={12}>
            <h4 className="heading">असाइनमेंट डीड घेणार</h4>
          </Grid>
                ...
                <Grid container spacing={2}>
                  <Grid item md={12}>
                    <Grid container spacing={2}>
                      <Grid item md={2}>
                        <InputLabel className="inputlabel">
                          <b>असाइनमेंट डीड घेणाराचा प्रकार </b>
                          <span>*</span>
                        </InputLabel>
                        <Select
                          value={userType}
                  ...
                  {userType == 1 ? (
                    <Grid item md={12}>
                      {isMHProperty == "no" ? (
                        <UserNoMHProperty
                          heading="असाइनमेंट डीड घेणाऱ्याची माहिती"
                          inputlabel="असाइनमेंट डीड घेणाऱ्याचे नाव"
                          isEdit={isEdit}
              ...
              >
                ...
                >
                  <Typography variant="h5" fontSize="14px" fontWeight={600}>
                    आणखी असाइनमेंट डीड घेणार आहे का?
                  </Typography>
                </Grid>
...
export default AssignmentDeedGhenar;
